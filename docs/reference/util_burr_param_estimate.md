...
This function will attempt to estimate the Burr prob parameter given
some vector of values `.x`. The function will return a list output by
default, and if the parameter `.auto_gen_empirical` is set to `TRUE`
...
will attempt to estimate the prob parameter of a Burr distribution.
...
#> 1 Burr             50 0.412  13.1  3.94   11.1   1.47 0.0468  21.4
