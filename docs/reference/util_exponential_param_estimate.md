...
given some vector of values. The function will return a list output by
...
function and combined with the estimated exponential data.
...
#> 1 Exponential        50 0.0460  45.0  8.88     67.2 NIST_MME 0.113
