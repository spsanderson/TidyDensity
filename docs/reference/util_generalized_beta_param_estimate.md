...
function and combined with the estimated generalized Beta data.
...
This function will attempt to estimate the generalized Beta shape1,
shape2, shape3, and rate parameters given some vector of values.
