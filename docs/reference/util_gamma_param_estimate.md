...
parameters given some vector of values. The function will return a list
output by default, and if the parameter `.auto_gen_empirical` is set to
...
function and combined with the estimated gamma data.
...
#> 1 Gamma            50 0.0153 0.968 0.279    0.235 NIST_…  1.41 0.197        7.16
#> 2 Gamma            50 0.0153 0.968 0.279    0.235 EnvSt…  1.38 0.197        7.01
#> 3 Gamma            50 0.0153 0.968 0.279    0.235 EnvSt…  1.34 0.197        6.79
