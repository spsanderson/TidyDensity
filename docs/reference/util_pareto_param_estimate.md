...
function and combined with the estimated pareto data.
...
This function will attempt to estimate the pareto shape and scale
...
#>   dist_type samp_size    min   max method  shape scale shape_ratio
#>   <chr>         <int>  <dbl> <dbl> <chr>   <dbl> <dbl>       <dbl>
#> 1 Pareto           50 0.0206  94.5 LSE    0.230  0.628      0.367 
#> 2 Pareto           50 0.0206  94.5 MLE    0.0206 0.251      0.0820
```
