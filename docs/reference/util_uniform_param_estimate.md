...
function and combined with the estimated uniform data.
...
This function will attempt to estimate the uniform min and max
...
#> # A tibble: 2 × 8
#>   dist_type samp_size   min   max method   min_est max_est ratio
#>   <chr>         <int> <dbl> <dbl> <chr>      <dbl>   <dbl> <dbl>
#> 1 Uniform          50  1.00  2.79 NIST_MME   0.985    2.77 0.355
#> 2 Uniform          50  1.00  2.79 NIST_MLE   1        3    0.333
