...
This function will automatically scale the data from 0 to 1 if it is not
already. This means you can pass a vector like `mtcars$mpg` and not
worry about it.
...
function and combined with the estimated beta data.
...
- EnvStats mme, see
  [`EnvStats::ebeta()`](https://alexkowa.github.io/EnvStats/reference/ebeta.html)
...
- .x:
  ...
  The vector of data to be passed to the function. Must be numeric, and
...
This function will attempt to estimate the beta shape1 and shape2
...
#>   dist_type samp_size   min   max  mean variance method       shape1 shape2
#>   <chr>         <int> <dbl> <dbl> <dbl>    <dbl> <chr>         <dbl>  <dbl>
#> 1 Beta             50 0.101 0.956 0.627   0.0442 Bayes         31.4   18.6 
#> 2 Beta             50 0.101 0.956 0.627   0.0442 NIST_MME       2.69   1.60
#> 3 Beta             50 0.101 0.956 0.627   0.0442 EnvStats_MME   2.76   1.64
#> # ℹ 1 more variable: shape_ratio <dbl>
```
