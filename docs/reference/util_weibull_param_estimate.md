...
function and combined with the estimated weibull data.
...
This function will attempt to estimate the weibull shape and scale
...
#> 1 Weibull          50 0.0622  6.09 NIST    1.19  1.91       0.623
