...
This function estimates the parameters of a normal distribution from the
...
- .x:
  ...
  A numeric vector containing the data to be fitted to a normal
  distribution.

## Value

The AIC value calculated based on the fitted normal distribution to the
provided data.

## Details

This function calculates the Akaike Information Criterion (AIC) for a
normal distribution fitted to the provided data.
