...
This function will attempt to estimate the zero truncated binomial size
and prob parameters given some vector of values.
...
#> 1 Zero-Truncated Binomial        32    10    33  19.7 MLE_Optim  33.0 0.597
...
#>   dist_type               samp_size   min   max  mean method     size  prob
#>   <chr>                       <int> <dbl> <dbl> <dbl> <chr>     <dbl> <dbl>
#> 1 Zero-Truncated Binomial       100     1     4  1.53 MLE_Optim     4   0.5
```
