...
function and combined with the estimated generalized Pareto data.
...
This function will attempt to estimate the generalized Pareto shape1,
shape2, and rate parameters given some vector of values.
