...
function and combined with the estimated cauchy data.
...
This function will attempt to estimate the cauchy location and scale
...
#> # A tibble: 1 × 8
#>   dist_type samp_size   min   max method location scale ratio
#>   <chr>         <int> <dbl> <dbl> <chr>     <dbl> <dbl> <dbl>
#> 1 Cauchy           50 -27.7  27.9 MASS      0.319  2.57 0.124
