...
function and combined with the estimated logistic data.
...
This function will attempt to estimate the logistic location and scale
...
#>   dist_type samp_size   min   max  mean basic_scale method        location scale
#>   <chr>         <int> <dbl> <dbl> <dbl>       <dbl> <chr>            <dbl> <dbl>
#> 1 Logistic         50 -3.87  8.29  2.70        1.34 EnvStats_MME      2.70  1.34
#> 2 Logistic         50 -3.87  8.29  2.70        1.34 EnvStats_MMUE     2.70  1.36
#> 3 Logistic         50 -3.87  8.29  2.70        1.34 EnvStats_MLE      2.70  1.67
#> # ℹ 1 more variable: shape_ratio <dbl>
```
