...
This function will generate `n` random points from a geometric
...
[`stats::rgeom()`](https://rdrr.io/r/stats/Geometric.html), and its
underlying `p`, `d`, and `q` functions. For more information please see
[`stats::rgeom()`](https://rdrr.io/r/stats/Geometric.html)
