...
function and combined with the estimated geometric data.
...
#> # A tibble: 2 × 9
#>   dist_type samp_size   min   max  mean variance sum_x method         shape
#>   <chr>         <int> <dbl> <dbl> <dbl>    <dbl> <dbl> <chr>          <dbl>
#> 1 Geometric        50     0    44  11.8     110.   589 EnvStats_MME  0.0782
#> 2 Geometric        50     0    44  11.8     110.   589 EnvStats_MVUE 0.0768
