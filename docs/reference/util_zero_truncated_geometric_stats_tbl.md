...
Returns distribution statistics for Zero-Truncated Geometric
...
distribution function and returns the relevant statistics for a
Zero-Truncated Geometric distribution. It requires data to be passed
from a `tidy_ztgeom` distribution function.
