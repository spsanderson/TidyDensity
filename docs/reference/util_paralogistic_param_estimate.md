...
function and combined with the estimated paralogistic data.
...
This function will attempt to estimate the paralogistic shape and rate
...
#>   dist_type    samp_size    min   max  mean    var method shape  rate
#>   <chr>            <int>  <dbl> <dbl> <dbl>  <dbl> <chr>  <dbl> <dbl>
#> 1 Paralogistic        50 0.0946  1.38 0.476 0.0622 MLE     2.57  1.44
#> # ℹ 1 more variable: shape_rate_ratio <dbl>
```
