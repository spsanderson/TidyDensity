...
#> Rows: 1
#> Columns: 16
#> $ tidy_function     <chr> "tidy_inverse_weibull"
#> $ function_call     <chr> "Inverse Weibull c(1, 1, 1)"
#> $ distribution      <chr> "Inverse Weibull"
...
#> $ range             <chr> "0 to Inf"
#> $ std_dv            <dbl> 224.0202
#> $ coeff_var         <dbl> 30.16798
#> $ computed_std_skew <dbl> 3.186903
#> $ computed_std_kurt <dbl> 11.84056
#> $ ci_lo             <dbl> 0.274315
#> $ ci_hi             <dbl> 31.62556
```
