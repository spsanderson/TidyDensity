...
This function will attempt to estimate the inverse Burr shape1, shape2,
and rate parameters given some vector of values `.x`. The function will
return a list output by default, and if the parameter
...
will attempt to estimate the shape1, shape2, and rate parameters of an
