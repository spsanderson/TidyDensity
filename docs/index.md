...
[TidyDensity](https://github.com/spsanderson/TidyDensity) is a
comprehensive R package that makes working with random numbers and
probability distributions easy, intuitive, and tidy. Whether you’re
simulating data, exploring distributions, or performing statistical
analysis, TidyDensity provides a unified interface that integrates
seamlessly with the tidyverse ecosystem.
...
![](reference/figures/README-plot_density-1.png)
...
![](reference/figures/README-more_than_nine_simulations-1.png)
...
Conduct](https://www.spsanderson.com/TidyDensity/CODE_OF_CONDUCT.md)
...
MIT License - see
[LICENSE.md](https://www.spsanderson.com/TidyDensity/LICENSE.md) for
details
