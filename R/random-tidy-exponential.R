...
#'
#' @name tidy_exponential
NULL

#' @export
#' @rdname tidy_exponential
...
tidy_exponential <- function(.n = 50, .rate = 1, .num_sims = 1,
  ...
  # Add descriptive attributes to tibble
