...
#'
#' tb <- rbinom(50, 1, .1)
#' util_binomial_param_estimate(tb)$parameter_tbl
#' util_binomial_param_estimate(tb)$combined_data_tbl %>%
#'   ggplot(aes(x = y, group = dist_type, color = "black", fill = dist_type)) +
