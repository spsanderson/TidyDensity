...
#'
#' @seealso \url{hhttps://www.statology.org/fit-gamma-distribution-to-dataset-in-r/}
...
#' @param .shape The mean of the randomly generated data. This is strictly 0 to infinity.
